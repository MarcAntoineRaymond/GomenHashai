...
- Docker images are published to: `ghcr.io/gomenhashai/gomenhashai`
...
- Helm charts are published to the following Helm chart repository: `https://gomenhashai.github.io/GomenHashai`
...
The Helm Chart is also signed using a gpg key and the `.prov` file is added to the release artifacts.
